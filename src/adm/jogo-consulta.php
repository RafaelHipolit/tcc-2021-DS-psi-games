    ...
    <main class="container-fluid">
        ...
        ?>
            ...
            <table class='table table-striped'>
                ...
                for ($i = 0; $i < sizeof($dados); $i++) {
                    ...
                    echo "<td><a href='jogo-alterar2.php?id=" . $dados[$i]['pk_id_jogo'] . " ' class='btn btn-outline-primary'>Alterar dados</a></td>";
                    echo "<td><a href='jogo-excluir2.php?id=" . $dados[$i]['pk_id_jogo'] . " 'class= 'btn btn-outline-danger'>Excluir</a></td>";
                    echo "<td><a href='jogo-carrinhos.php?id=" . $dados[$i]['pk_id_jogo'] . " ' class='btn btn-outline-primary'>Registros de compras do jogo</a></td>";
                    echo "</tr>";
                }
                ?>
            </table>
        ...
        <?php
            ...
            if (isset($_GET['nome'])) {
                ...
                echo "<h1>Nenhum jogo cadastrado</h1>";
            }
        }
        ?>
