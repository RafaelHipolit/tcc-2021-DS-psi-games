...
if (isset($_GET['nome'])) {
    ...
    $query = "select pk_id_jogador, nome, nickname, email from jogadores where nome like '%" . $_GET['nome'] . "%';";
} else {
...
<body>
    ...
    <main class="container-fluid">
        ...
        <form action="jogador-consulta.php" method="get">
            <label for="nome-jogador">Nome do jogador:</label>
            <input type="text" name="nome" value="<?php if(isset($_GET['nome'])){echo $_GET['nome'];} ?>" id="nome-jogador">
            <input type="submit" class="btn btn-info" value="Buscar">
        </form>

        <p>Para visualizar todos os jogadores deixe o campo acima em branco e clique em "Buscar"</p>
        ...
        ?>
            <table class='table table-striped'>
                ...
                for ($i = 0; $i < sizeof($dados); $i++) {
                    ...
                    echo "<td><a href='jogador-alterar2.php?id=" . $dados[$i]['pk_id_jogador'] . " ' class='btn btn-outline-primary' >Alterar dados</a></td>";
                    echo "<td><a href='jogador-exclui2.php?id=" . $dados[$i]['pk_id_jogador'] . " ' class='btn btn-outline-danger' >Excluir</a></td>";
                    echo "<td><a href='jogador-carrinhos.php?id=" . $dados[$i]['pk_id_jogador'] . " ' class='btn btn-outline-primary' >Carrinhos do jogador</a></td>";
                    echo "</tr>";
                }
                ?>
            </table>
        ...
        <?php
            ...
            if(isset($_GET['nome'])){
                echo "Nenhum jogador encontrado com o nome " . $_GET['nome'];
            }else{
