...
<body>
    ...
    if (!(isset($_POST['nome']) && isset($_POST['nickname']) && isset($_POST['email']) && isset($_POST['senha']))) {
        header('location: jogador-cadastrar1.php');
        exit();
    }

    if (empty($_POST["nome"]) || empty($_POST["nickname"]) || empty($_POST["email"]) || empty($_POST["senha"])) {
        header('location: jogador-cadastrar1.php');
        exit();
    }
    ...
    <main class="container-fluid">
        ...
        <h2>O seguinte usuário foi cadastrado com sucesso</h2>
        <hr>
