...
<nav class="navbar navbar-expand-sm bg-primary navbar-dark">
    ...
    <form method="GET" action="jogador-exclui2.php">
        <label for="input-id"> Digite o id do jogador que deseja excluir</label>

        <input type="number" size="5" name="id" required id="input-id" />
        <input type="submit" class="btn btn-primary" value="excluir jogador" />
    </form>
    <br />
