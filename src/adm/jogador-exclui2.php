...
<body>
    ...
    if (mysqli_num_rows($consulta) == 0)
        ...
        echo "<h1 style='color: red;'>ATENÇÃO: ao excluir o jogadador será excluido tambem todos os seus registros de compra de jogos e registros de carrinhos</h1>";

        echo"<a href='jogador-exclui3.php?id=$codigo' class='btn btn-danger'>Excluir</a>";
    }
    ?>
    
    <br /><br /><a href="jogador-exclui1.php" class="btn btn-secondary">cancelar</a>
    </main>
