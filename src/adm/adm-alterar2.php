...
<nav class="navbar navbar-expand-sm bg-primary navbar-dark">
    ...
    if (mysqli_num_rows($consulta) == 0)
        ...
        $d = $linha["email"];
    ?>
        <form method="POST" action="adm-alterar3.php">
            nome: <br />
            <input type="text" size="50" name="nome" required value="<?php echo $n; ?>" /><br /><br />
            email: <br />
            <input type="email" size="50" name="email" required value="<?php echo $d; ?>" /><br /><br />
            <h2 style="color: red;">
          <?php
          ...
          <p>Para não alterar a senha, deixe o campo abaixo em branco </p>
            ...
            <input type="submit" class="btn btn-primary" value="Alterar administrador" />
        </form>
    <?php
    }
    ?>
    <br /><br /><a href="adm-alterar1.php" class="btn btn-secondary">Retornar</a>
    </main>
