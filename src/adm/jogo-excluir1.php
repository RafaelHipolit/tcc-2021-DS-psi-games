...
<nav class="navbar navbar-expand-sm bg-primary navbar-dark">
    ...
    <h2>Excluir jogo</h2>
    <form method="GET" action="jogo-excluir2.php">
        <label for="input-id"> Digite o id do jogo que deseja excluir</label>

        <input type="number" size="5" name="id" required id="input-id" />
        <input type="submit" class="btn btn-primary" value="excluir jogo" />
    </form>
    <br />
